  ...
  return (
    <div className="relative min-h-screen">
        ...
        <div className="relative z-10000 bg-transparent">
            ...
            {/* 2. WORK EXPERIENCE */}
            <div id="experiences" ref={experienceSectionRef} className="py-20">
            ...
            {/* FOOTER */}
            <footer id="contact" className="py-12 sm:py-20 text-center border-slate-100">
              <p className="text-slate-400 font-bold tracking-[0.3em] text-[10px] sm:text-xs uppercase mb-4 sm:mb-6">Connect with me</p>
              <div className="flex justify-center gap-4 sm:gap-6 font-black text-slate-900 text-xs sm:text-sm">
              ...
              <p className="mt-4 sm:mt-5 text-[10px] sm:text-xs text-slate-400 font-bold tracking-[0.1em] uppercase">© 2026 XUAN LE</p>
            </footer>
        </div>
